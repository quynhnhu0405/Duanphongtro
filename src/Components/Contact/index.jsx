    ...
    <Card >
      <div className="lg:flex items-center">
        ...
        <Button color="danger" variant="solid " className="w-52 p-4">
          <a  target="_blank" rel="nofollow" href="tel:0785604557"><WhatsAppOutlined /> &nbsp; &nbsp; ĐT: 0785604557 </a>
        </Button>
        <br></br>
        <Button color="primary" variant="solid" className="w-52">
          <a target="_blank" rel="nofollow" href="https://zalo.me/0909316890"><MessageOutlined/> &nbsp; &nbsp; Zalo: 0785604557 </a>
        </Button>
        </div>
      </div>
    </Card>
