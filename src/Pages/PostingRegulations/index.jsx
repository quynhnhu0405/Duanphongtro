...
const PostingRegulation = () => {
  return (
    <div class="box">
        <header class="mb-3">
            <h1 class="fs-2 fw-normal lh-sm mb-2">Quy định đăng tin</h1>
        </header>
        <div class="box__text">
            <h3>A. QUY ĐỊNH CHUNG:</h3>
            <p>- Không sử dụng bất kỳ thiết bị, phần mềm, quy trình, phương tiện để can thiệp hay cố gắng can thiệp vào hoạt động đúng đắn trên Phongtro123.com</p>
            ...
            <h3>B. QUY ĐỊNH VỀ TIN ĐĂNG (CÁC TRƯỜNG HỢP TIN ĐĂNG KHÔNG ĐƯỢC DUYỆT)</h3>
            <p>
            ...
            <p><strong>9.</strong>&nbsp;Quý khách tuyệt đối không sao chép nội dung quảng cáo từ các nhà quảng cáo khác. Trong trường hợp Phongtro123.com&nbsp;nhận được khiếu nại của khách hàng và xác định được tin đăng của Quý khách là tin sao chép nội dung, tin đăng của Quý khách có thể bị xóa hoặc chỉnh sửa lại nội dung mà không cần thông báo trước.</p>
            ...
            <h3>C. QUY ĐỊNH VỀ TÀI KHOẢN:</h3>
            <p>- Tại Phongtro123.com, chúng tôi rất quan tâm đến vấn đề minh bạch thông tin, vì vậy tài khoản phải cung cấp thông tin thật của người sử dụng (họ tên, số điện thoại...).</p>
            ...
            <p>- Đăng tin không đúng sự thật: cố ý cung cấp nội dung sai, giả mạo so với giao dịch thực tế (bao gồm thông tin về bất động sản, giá, hình ảnh, địa chỉ...) và hướng khách hàng đến 1 giao dịch khác, điều này làm ảnh hưởng rất lớn đến lòng tin, uy tín của website Phongtro123.com đối với người dùng. Nếu bất động sản đã giao dịch xong, xin vui lòng cập nhật lại trạng thái của bất động sản (đã bán, đã cho thuê).</p>
            ...
            <p>- Sử dụng phần mềm UP TOP tự động được cung cấp bởi bên thứ 3 ngoài kiểm soát của Phongtro123.com, khiến máy chủ quá tải gây ảnh hưởng tốc độ website. Nếu có nhu cầu UP TOP tự động vui lòng sử dụng tính năng được cung cấp bởi Phongtro123.com để website hoạt động ổn định.</p>
            <h3>D. QUY ĐỊNH VỀ CHI PHÍ:</h3><p>- Mỗi tài khoản đăng ký lần đầu tiên được tặng 1 tin miễn phí có hạn sử dụng trong vòng 7 ngày kể từ lúc đăng ký, bạn sẽ trả phí nếu muốn sử dụng tiếp dịch vụ đăng tin thường, VIP, UP TOP, hoặc các dịch vụ có phí khác.</p>
            <p>- Giúp giao dịch cho thuê diễn ra nhanh chóng cũng là 1 trong những mục tiêu của Phongtro123.com, vì vậy phí trả cho số ngày mua dịch vụ sẽ không được hoàn lại khi giao dịch đã thành công sớm hơn.</p>
